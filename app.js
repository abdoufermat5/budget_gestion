...
var budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            //2 calculate budget : icome - expenses
        ...
        getPercentage: function(){
           var all_percentages = data.allItems.exp.map(function(cur) {
...
var UIController = (function () {
    ...
    return {
        ...
        displayMonth: function () {
            ...
            month = now.getMonth();
            day = now.getUTCDay();
            document.querySelector(DOMstrings.dateLabel).textContent = days[day] + ', ' + months[month] + ' ' + year;
        },
